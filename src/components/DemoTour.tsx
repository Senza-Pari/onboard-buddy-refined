  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        exit={{ opacity: 0 }}
      >
        {/* Tour card: floating top-right on all steps */}
        <motion.div
          className="pointer-events-auto fixed top-4 left-4 right-4 md:left-auto md:right-6 md:top-6 md:max-w-sm rounded-2xl shadow-xl bg-white"
